...
export default function LandingPage() {
  ...
  /* ----------------------
     marquee CSS inserted inline - FIXED
     ---------------------- */
  const marqueeStyle = `
  ...
  return (
    <div className="font-[Work Sans,sans-serif] text-[#111618] overflow-x-hidden">
      ...
      {/* Header */}
 <header className="navbar-container w-full mx-auto flex items-center justify-between px-6 py-4 shadow-sm border-b border-gray-200 bg-white sticky top-0 z-50">
  {/* Left: Logo + Title */}
  <div className="navbar-left flex items-center gap-2">
    <div className="navbar-logo w-16 h-16">
      <img
        src={TiedyLogo}
        alt="Tiedy logo"
    ...
    <h1 className="navbar-title text-xl font-bold">Tiedy</h1>
  </div>

  {/* Right: Navigation */}
  <nav className="navbar-right flex gap-8 items-center">
    <a href="#how" className="navbar-link no-underline">
      <span className="font-semibold text-black hover:text-[#06AED5] transition-colors">
        How it works
      </span>
    </a>
    <a href="#contact" className="navbar-link no-underline">
      <span className="font-semibold text-black hover:text-[#06AED5] transition-colors">
        Contact Us
      </span>
    </a>
    ...
    {/* Store buttons */}
    <div className="navbar-buttons flex gap-3">
      <a
        href="#download"
        className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-[#06AED5] hover:bg-[#0496c2] text-white font-semibold shadow"
      >
        <img
          src={AndroidLogo}
          alt="Google Play"
      ...
      {/* Hero Section */}
<section
  className="w-full mx-auto flex flex-col items-center justify-center text-center px-4 py-24 bg-cover bg-center"
  style={{
...
>
  <div className="flex flex-col gap-6 items-center">
    ...
    <div className="max-w-3xl">
      <AnimatePresence mode="wait">
        <motion.h2
          ...
          className="text-white text-4xl md:text-6xl font-black leading-tight tracking-[-0.02em]"
        >
      ...
      <motion.p
        ...
        className="text-gray-200 mt-4 text-lg md:text-xl max-w-2xl mx-auto"
      >
    ...
    <div className="flex gap-4 mt-6 flex-wrap justify-center">
      <a
        href="#download"
        className="inline-flex items-center justify-center gap-3 px-5 py-3 rounded-md bg-[#06AED5] hover:bg-[#0496c2] text-white font-bold shadow"
      ...
      <a
        href="#download"
        className="inline-flex items-center justify-center gap-3 px-5 py-3 rounded-md bg-[#06AED5] hover:bg-[#0496c2] shadow"
...
<section
  id="services"
  className="w-full mx-auto px-6 py-20 bg-gray-50 text-center"
>
  <h3 className="text-4xl font-bold mb-6">We wash it all</h3>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    {[
      ...
      <div
        key={i}
        className="border border-gray-200 rounded-lg shadow-sm hover:shadow-lg transition overflow-hidden flex flex-col"
      >
        {/* Top half: image */}
...
<section
  id="how"
  className="w-full mx-auto px-6 py-20 bg-cover bg-center relative"
...
>
  ...
  <div className="relative text-center">
    <h3 className="text-4xl font-bold mb-6 text-white">Why Choose Tiedy?</h3>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      {/* Card 1 */}
      <div className="p-6 bg-white/10 rounded-lg text-left">
        <Clock className="w-10 h-10 text-[#06AED5] mb-4" />
        <h4 className="text-xl font-semibold mb-2 text-white">Fast Turnaround</h4>
      ...
      {/* Card 2 */}
      <div className="p-6 bg-white/10 rounded-lg text-left">
        <Truck className="w-10 h-10 text-[#06AED5] mb-4" />
        <h4 className="text-xl font-semibold mb-2 text-white">Free Pickup & Delivery</h4>
        <p className="text-gray-200">
      ...
      {/* Card 3 */}
      <div className="p-6 bg-white/10 rounded-lg text-left">
        <ThumbsUp className="w-10 h-10 text-[#06AED5] mb-4" />
        <h4 className="text-xl font-semibold mb-2 text-white">Quality Guaranteed</h4>
        <p className="text-gray-200">
...
<section
  id="service-areas"
  className="w-full mx-auto px-6 py-20 bg-white"
>
  <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
    ...
    {/* Service Areas Side */}
    <div className="text-left h-[450px] flex flex-col">
      ...
      {/* Scrollable list */}
      <ul className="space-y-4 text-lg font-semibold text-gray-800 overflow-y-auto pr-2 flex-1 custom-scrollbar">
      ...
      {/* FAQ Section - placed before testimonials */}
   {/* FAQ Section */}
   <section
      className="relative w-full mx-auto px-6 py-16 bg-cover bg-center text-white"
      style={{ backgroundImage: `url(${HeroBackground})` }}
    >
      ...
      {/* Testimonials - horizontally scrolling marquee with headshots and name beside circle */}
        ...
        <div className="marquee">
          <div className="marquee-track">
            {[
              ...
              // duplicate to allow continuous effect
              .concat([
                {
                  name: "Sarah M.",
                  role: "Happy Customer",
                ...
                },
                {
                  ...
                  role: "Happy Customer",
                  text: "I love the convenience of Washr. No more trips to the laundromat! Pickup and delivery are always on time, and the quality is excellent.",
                  img: "https://lh3.googleusercontent.com/aida-public/AB6AXuACmZ5fBwM08qvrbAbAXT9faBm3bApz_ZoQQYYE3ea-MYKcZKfGwXlXipfdqNaTkqgc31W1eJPLh-PVB-iZgr4ZaS0OSo_3GSXMR3U0MMfcZwR793AsoXBaP1ZM5lZDc5T-7TaIPN2vdHfulray1cdzeLWCgrgQQp-j_AqxQ2Qs_fV8QDd9vlbMoKFNXq7uW9u-M4beND5iTsFBk9M0ApDKvehr1KzFWohubAKzquUa_gKWuHG7ZGO5mpoDuk3DByDFsYb_QvGBMLH0-",
                },
                {
                  name: "Emily L.",
                  role: "Happy Customer",
              ...
              .map((t, i) => (
                <div key={i} className="min-w-[320px] max-w-[420px] p-6 border border-gray-200 rounded-lg shadow-sm bg-white flex gap-4">
      ...
      {/* Footer */}
      <footer className="w-full mx-auto bg-gray-800 text-gray-400 px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h4 className="text-white font-semibold mb-3">Tiedy</h4>
            <p>
              On-demand laundry service. We pick up, wash, and deliver your
              laundry, so you can focus on what matters.
            </p>
          </div>
          <div>
          ...
          <div>
            <h4 className="text-white font-semib't mb-3">Support</h4>
            <ul className="space-y-2">
              <li>Contact Us</li>
              <li>FAQs</li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center text-sm">
          © {new Date().getFullYear()} Ziedy. All rights reserved.
        </div>
      </footer>
      </div>
  );
